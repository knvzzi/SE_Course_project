...
#define FILE "C:\\ПОИТ\\3 sem\\SE_Course_project\\KTI-2023\\KTI2023\\ASM\\ASM.asm"

int _tmain(int argc, wchar_t* argv[])
{
	argc = 2; 
	argv = new wchar_t* [2]; 
	wchar_t* filename = (wchar_t*)L"-in:C:\\ПОИТ\\3 sem\\SE_Course_project\\KTI-2023\\KTI2023\\KTI2023\\KTI.txt";
	argv[1] = filename; 
	...
	try
	{
		...
		WritePolishNotationToFile("C:/ПОИТ/3 sem/SE_Course_project/KTI-2023/KTI2023/poliz/poliz.txt", lex.lextable);
		Log::Close(log);
